...
{
    public class FrmDbMigrationService : ITransientDependency
    {
        public ILogger<FrmDbMigrationService> Logger { get; set; }

        private readonly IDataSeeder _dataSeeder;
        private readonly IEnumerable<IFrmDbSchemaMigrator> _dbSchemaMigrators;
        private readonly ITenantRepository _tenantRepository;
        private readonly ICurrentTenant _currentTenant;

        public FrmDbMigrationService(
            IDataSeeder dataSeeder,
            IEnumerable<IFrmDbSchemaMigrator> dbSchemaMigrators,
            ...
            ICurrentTenant currentTenant)
        {
            ...
            Logger = NullLogger<FrmDbMigrationService>.Instance;
        }
